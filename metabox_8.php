<?php
/**
 * Plugin Name: Metabox_8
 * Plugin URI:  Plugin URL Link
 * Author:      Plugin Author Name
 * Author URI:  Plugin Author Link
 * Description: This plugin make for pratice wich is "Metabox_8".
 * Version:     0.1.0
 * License:     GPL-2.0+
...
function plugin_loaded_function() {
    load_plugin_textdomain('mb_8', false, dirname(__FILE__)."/languages");
...
function reginster_metabox_function(){
    add_meta_box('metabox_7', __('Your InFo:','mb_8'), 'regester_metabox_function','post');
}
...
function regester_metabox_function($post){
    ...
    $label_1 = __('Your Name:','mb_8');
    $label_2 = __('Your color:','mb_8');
